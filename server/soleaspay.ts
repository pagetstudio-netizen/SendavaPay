...
export const SOLEASPAY_SERVICES: SoleasPayService[] = [
  // Cameroun — via PayDunya SoftPay (USSD push)
  ...
  // Côte d'Ivoire — via PayDunya SoftPay (Wave redirige via wave-ci SoftPay URL)
  ...
  // Burkina Faso — via PayDunya SoftPay
  ...
  // Congo Brazzaville — via SoleasPay
