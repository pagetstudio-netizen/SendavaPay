...
}`}),e.jsxs(m,{type:"tip",title:"Idempotence",children:["Vérifiez toujours si la ",e.jsx("code",{children:"reference"})," a déjà été traitée avant d'agir — SendavaPay peut renvoyer le même événement en cas d'échec de votre endpoint."]})]}),e.jsxs("div",{id:"s-wh-signature",className:"scroll-mt-4 mb-14",children:[e.jsx("h3",{className:"text-lg font-semibold mb-1",children:"Vérification HMAC"}),e.jsx(m,{type:"danger",title:"Toujours vérifier la signature",children:"Ne traitez jamais un webhook sans vérifier sa signature. Un webhook non vérifié peut être forgé pour simuler un paiement réussi."}),e.jsx(a,{language:"bash — calcul de la signature",code:`HMAC_SHA256(key=WEBHOOK_SECRET, data=JSON.stringify(body))
...
// data.sent: true, data.responseStatus: 200, data.responseTime: 142`}),e.jsxs("h4",{className:"text-xs font-semibold uppercase tracking-wide text-muted-foreground mt-5 mb-2",children:["Réponse ",e.jsx("span",{className:"text-green-600 dark:text-green-400",children:"200 OK"})]}),e.jsx(a,{language:"json",code:`{
  ...
  "responseStatus": 200,
  "responseTime": 142
}`})]})]}),e.jsxs("section",{id:"s-operators",children:[e.jsx("h2",{className:"text-2xl font-bold border-b pb-3 mb-6",children:"Pays & Opérateurs"}),e.jsx("p",{className:"text-sm text-muted-foreground mb-4",children:"Chaque paiement est crédité sur le wallet correspondant au pays. Les fonds d'un pays ne peuvent être retirés que via le wallet de ce même pays."}),e.jsx("div",{className:"overflow-x-auto rounded-lg border text-sm",children:e.jsxs("table",{className:"w-full",children:[e.jsx("thead",{className:"bg-muted/70",children:e.jsxs("tr",{children:[e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"Pays"}),e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"Code"}),e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"Devise"}),e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"Opérateurs"})]})}),e.jsx("tbody",{children:[["🇹🇬 Togo","TG","XOF","TMoney, Moov Money (Flooz)"],["🇧🇯 Bénin","BJ","XOF","MTN MoMo, Moov Money"],["🇸🇳 Sénégal","SN","XOF","Orange Money, Wave, Free Money, Wizall"],["🇨🇮 Côte d'Ivoire","CI","XOF","MTN MoMo, Orange Money, Wave, Moov Money"],["🇲🇱 Mali","ML","XOF","Orange Money, Wave, Moov Money"],["🇧🇫 Burkina Faso","BF","XOF","Orange Money, Moov Money"],["🇨🇲 Cameroun","CM","XAF","MTN MoMo, Orange Money"],["🇬🇳 Guinée","GN","GNF","Orange Money, MTN MoMo, Cellcom"],["🇨🇩 RD Congo","COD","CDF","Vodacom M-Pesa, Airtel Money, Orange Money"],["🇨🇬 Congo Brazzaville","COG","XAF","Airtel Money, MTN Money"]].map(([s,n,l,u])=>e.jsxs("tr",{className:"border-t hover:bg-muted/20",children:[e.jsx("td",{className:"p-3 text-xs font-medium",children:s}),e.jsx("td",{className:"p-3 font-mono text-xs",children:n}),e.jsx("td",{className:"p-3 font-mono text-xs",children:l}),e.jsx("td",{className:"p-3 text-xs text-muted-foreground",children:u})]},n))})]})}),e.jsxs(m,{type:"info",title:"OTP requis",children:["Les opérateurs ",e.jsx("strong",{children:"Orange Money"})," (BF, CI, GN, ML, SN) retournent ",e.jsx("code",{children:"requiresOtp: true"})," à l'initiation du paiement. Tous les autres opérateurs n'en ont pas besoin."]})]}),e.jsxs("section",{id:"s-statuses",children:[e.jsx("h2",{className:"text-2xl font-bold border-b pb-3 mb-6",children:"Statuts de transaction"}),e.jsx("h3",{className:"text-base font-semibold mb-3",children:"Statuts de paiement (dépôt)"}),e.jsx("div",{className:"overflow-x-auto rounded-lg border text-sm mb-8",children:e.jsxs("table",{className:"w-full",children:[e.jsx("thead",{className:"bg-muted/70",children:e.jsxs("tr",{children:[e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"Statut"}),e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"Description"}),e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"Type"})]})}),e.jsx("tbody",{children:[["pending","Transaction créée, en attente d'initiation","transitoire"],["processing","Invite envoyée, en attente de confirmation du payeur","transitoire"],["completed","Paiement confirmé, fonds crédités sur le wallet","terminal ✓"],["failed","Paiement refusé, annulé ou erreur opérateur","terminal"],["cancelled","Annulé avant traitement","terminal"]].map(([s,n,l])=>e.jsxs("tr",{className:"border-t hover:bg-muted/20",children:[e.jsx("td",{className:"p-3",children:e.jsx("span",{className:`px-2 py-0.5 rounded text-xs font-mono font-medium ${s==="completed"?"bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400":s==="failed"||s==="cancelled"?"bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400":"bg-muted text-muted-foreground"}`,children:s})}),e.jsx("td",{className:"p-3 text-xs text-muted-foreground",children:n}),e.jsx("td",{className:"p-3 text-xs text-muted-foreground",children:l})]},s))})]})}),e.jsx("h3",{className:"text-base font-semibold mb-3",children:"Statuts de retrait (pay-out)"}),e.jsx("div",{className:"overflow-x-auto rounded-lg border text-sm",children:e.jsxs("table",{className:"w-full",children:[e.jsx("thead",{className:"bg-muted/70",children:e.jsxs("tr",{children:[e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"Statut"}),e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"Description"}),e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"Type"})]})}),e.jsx("tbody",{children:[["queued","En file d'attente — le worker va le traiter","transitoire"],["processing","En cours de traitement chez l'opérateur","transitoire"],["provider_pending","En attente de confirmation du fournisseur de paiement","transitoire"],["completed","Retrait effectué — fonds virés sur le Mobile Money","terminal ✓"],["failed","Retrait échoué — fonds non débités","terminal"],["reversed","Fonds retournés sur le wallet après un échec définitif","terminal"],["cancelled","Retrait annulé avant traitement","terminal"]].map(([s,n,l])=>e.jsxs("tr",{className:"border-t hover:bg-muted/20",children:[e.jsx("td",{className:"p-3",children:e.jsx("span",{className:`px-2 py-0.5 rounded text-xs font-mono font-medium ${s==="completed"?"bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400":s==="failed"||s==="cancelled"||s==="reversed"?"bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400":"bg-muted text-muted-foreground"}`,children:s})}),e.jsx("td",{className:"p-3 text-xs text-muted-foreground",children:n}),e.jsx("td",{className:"p-3 text-xs text-muted-foreground",children:l})]},s))})]})})]}),e.jsxs("section",{id:"s-errors",children:[e.jsx("h2",{className:"text-2xl font-bold border-b pb-3 mb-6",children:"Codes d'erreur"}),e.jsx(a,{language:"json — format d'erreur",code:`{
  "success": false,
  "error":   "INSUFFICIENT_BALANCE",
  "code":    "INSUFFICIENT_BALANCE"
}`}),e.jsx("div",{className:"overflow-x-auto rounded-lg border text-sm mt-4",children:e.jsxs("table",{className:"w-full",children:[e.jsx("thead",{className:"bg-muted/70",children:e.jsxs("tr",{children:[e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"HTTP"}),e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"Code"}),e.jsx("th",{className:"text-left p-3 font-semibold text-xs uppercase tracking-wide text-muted-foreground",children:"Description"})]})}),e.jsx("tbody",{children:[["400","INVALID_REQUEST","Paramètres manquants ou malformés"],["400","DUPLICATE_REFERENCE","externalReference déjà utilisée pour un paiement actif"],["400","INSUFFICIENT_BALANCE","Solde insuffisant sur le wallet pour le retrait"],["400","UNSUPPORTED_COUNTRY","Code pays non pris en charge"],["400","WALLET_NOT_FOUND","Wallet du pays introuvable sur votre compte"],["400","INVALID_PHONE_FORMAT","Numéro de téléphone invalide — format E.164 requis (+22890…)"],["400","OPERATOR_COUNTRY_MISMATCH","Opérateur incompatible avec le pays demandé"],["400","PAYOUT_OPERATOR_OFFLINE","Opérateur en maintenance — retraits temporairement indisponibles"],["400","AMOUNT_TOO_LOW","Montant inférieur au minimum autorisé (100)"],["400","AMOUNT_TOO_HIGH","Montant supérieur au maximum autorisé (5 000 000)"],["409","DUPLICATE_WITHDRAWAL","Un retrait avec cet externalReference existe déjà"],["401","UNAUTHORIZED","Header Authorization manquant ou malformé"],["401","INVALID_API_KEY","Clé SDK invalide ou inexistante"],["403","API_KEY_INACTIVE","Clé SDK désactivée"],["403","SDK_NOT_ENABLED","Accès SDK non activé — contactez le support"],["403","ACCOUNT_NOT_VERIFIED","KYC non validé"],["404","NOT_FOUND","Transaction introuvable pour cette référence"],["410","TOKEN_EXPIRED","paymentToken expiré (30 min dépassées)"],["503","API_MAINTENANCE","API temporairement en maintenance"]].map(([s,n,l],u)=>e.jsxs("tr",{className:"border-t hover:bg-muted/20",children:[e.jsx("td",{className:"p-3 font-mono text-xs text-muted-foreground",children:s}),e.jsx("td",{className:"p-3 font-mono text-xs text-primary",children:n}),e.jsx("td",{className:"p-3 text-xs text-muted-foreground",children:l})]},u))})]})})]}),e.jsxs("section",{id:"s-rate",className:"pb-16",children:[e.jsx("h2",{className:"text-2xl font-bold border-b pb-3 mb-6",children:"Rate Limiting"}),e.jsx("div",{className:"grid sm:grid-cols-3 gap-3 mb-6",children:[["100 req / min","Par clé SDK"],["5 secondes","Intervalle polling recommandé"],["Retry 429","Backoff exponentiel"]].map(([s,n])=>e.jsxs("div",{className:"p-4 rounded-lg border bg-muted/30 text-center",children:[e.jsx("p",{className:"text-lg font-bold text-primary",children:s}),e.jsx("p",{className:"text-xs text-muted-foreground",children:n})]},s))}),e.jsx(a,{language:"json — réponse HTTP 429",code:`HTTP/1.1 429 Too Many Requests
{
  "success": false,
  "error":   "Trop de requêtes. Réessayez dans 60 secondes.",
  "code":    "RATE_LIMITED"
}`}),e.jsx(m,{type:"tip",children:"Pour le polling de statut, utilisez un intervalle de 5 secondes minimum. Implémentez un backoff exponentiel sur les réponses 429."})]})]})]})}function vt(){const{user:o,isLoading:d}=ge(),{toast:r}=fe(),[c,g]=p.useState(""),[v,s]=p.useState(""),[n,l]=p.useState(""),[u,M]=p.useState(""),[w,C]=p.useState(null),[te,se]=p.useState(null),[S,G]=p.useState(null),[ae,D]=p.useState(!1),{data:O,isLoading:ue}=Z({queryKey:["/api/api-maintenance-status"],refetchInterval:1e4}),{data:X,isLoading:pe}=Z({queryKey:["/api/user/api-permissions"],enabled:!!(o!=null&&o.isVerified)}),{data:$=[],isLoading:H}=Z({queryKey:["/api/api-keys"],enabled:!!(o!=null&&o.isVerified)&&!(O!=null&&O.enabled)}),V=ne({mutationFn:async t=>(await oe("POST","/api/api-keys",t)).json(),onSuccess:()=>{ie.invalidateQueries({queryKey:["/api/api-keys"]}),g(""),s(""),l(""),M(""),C(null),D(!1),r({title:"Clé créée",description:"Votre nouvelle clé API a été créée avec succès"})},onError:t=>{r({title:"Erreur",description:t.message||"Impossible de créer la clé",variant:"destructive"})}}),W=ne({mutationFn:async t=>{await oe("DELETE",`/api/api-keys/${t}`)},onSuccess:()=>{ie.invalidateQueries({queryKey:["/api/api-keys"]}),r({title:"Clé supprimée"})},onError:()=>{r({title:"Erreur",description:"Impossible de supprimer la clé",variant:"destructive"})}}),re=t=>{navigator.clipboard.writeText(t),se(t),r({title:"Copié"}),setTimeout(()=>se(null),2e3)},he=()=>{if(!c.trim()){r({title:"Erreur",description:"Veuillez entrer un nom pour la clé",variant:"destructive"});return}if(!w){r({title:"Erreur",description:"Veuillez sélectionner un type d'API",variant:"destructive"});return}V.mutate({name:c.trim(),appName:v.trim()||void 0,webhookUrl:n.trim()||void 0,redirectUrl:u.trim()||void 0,apiType:w})};if(d||ue)return e.jsx(I,{children:e.jsx("div",{className:"flex items-center justify-center min-h-[60vh]",children:e.jsx(A,{className:"h-8 w-8 animate-spin text-primary"})})});if(O!=null&&O.enabled)return e.jsx(I,{children:e.jsx("div",{className:"flex items-center justify-center min-h-[60vh] p-4",children:e.jsxs(f,{className:"max-w-lg w-full text-center",children:[e.jsxs(y,{children:[e.jsx("div",{className:"mx-auto mb-4 h-16 w-16 rounded-full bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center",children:e.jsx(Re,{className:"h-8 w-8 text-orange-600 dark:text-orange-400"})}),e.jsx(N,{className:"text-2xl",children:"API en maintenance"}),e.jsx(T,{className:"text-base",children:"L'API est temporairement indisponible"})]}),e.jsx(b,{children:e.jsx(F,{href:"/dashboard",children:e.jsxs(x,{variant:"outline",children:[e.jsx(J,{className:"h-4 w-4 mr-2"}),"Retour au tableau de bord"]})})})]})})});if(!(o!=null&&o.isVerified))return e.jsx(I,{children:e.jsxs("div",{className:"space-y-6 p-6",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-bold",children:"API de Paiement"}),e.jsx("p",{className:"text-muted-foreground",children:"Intégrez SendavaPay dans vos applications"})]}),e.jsxs(f,{children:[e.jsxs(y,{children:[e.jsxs(N,{className:"flex items-center gap-2",children:[e.jsx(ce,{className:"h-5 w-5 text-yellow-500"}),"Vérification requise"]}),e.jsx(T,{children:"Votre compte doit être vérifié pour accéder à l'API"})]}),e.jsxs(b,{className:"space-y-4",children:[e.jsx("p",{className:"text-muted-foreground",children:"Pour des raisons de sécurité, seuls les comptes vérifiés peuvent accéder à l'API SendavaPay."}),e.jsx(F,{href:"/dashboard/kyc",children:e.jsxs(x,{children:[e.jsx(ce,{className:"h-4 w-4 mr-2"}),"Vérifier mon compte"]})})]})]})]})});const E=(X==null?void 0:X.apiSdkEnabled)??!1,k=$.filter(t=>t.apiType==="sdk"),h=$.filter(t=>t.apiType==="redirect"),Y=({keyItem:t})=>e.jsxs("div",{className:"flex flex-col gap-3 p-4 border rounded-lg","data-testid":`api-key-${t.id}`,children:[e.jsxs("div",{className:"flex flex-col sm:flex-row sm:items-start justify-between gap-3",children:[e.jsxs("div",{className:"space-y-1 flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center gap-2 flex-wrap",children:[e.jsx("span",{className:"font-medium",children:t.name}),e.jsx(L,{variant:t.isActive?"default":"secondary",children:t.isActive?"Active":"Inactive"}),e.jsx(L,{variant:"outline",className:t.apiType==="sdk"?"border-purple-400 text-purple-700 dark:text-purple-300":"",children:t.apiType==="sdk"?"SDK":"Redirection"})]}),t.appName&&e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Application : ",t.appName]}),e.jsx("code",{className:"text-sm text-muted-foreground font-mono block truncate",children:t.apiKey}),e.jsxs("p",{className:"text-xs text-muted-foreground",children:["Créée le ",new Date(t.createdAt).toLocaleDateString("fr-FR"),t.requestCount>0&&` • ${t.requestCount} requêtes`]})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(x,{variant:"outline",size:"sm",onClick:()=>re(t.apiKey),"data-testid":`button-copy-${t.id}`,children:te===t.apiKey?e.jsx(R,{className:"h-4 w-4"}):e.jsx(B,{className:"h-4 w-4"})}),e.jsx(x,{variant:"outline",size:"sm",onClick:()=>G(t),disabled:W.isPending,"data-testid":`button-delete-${t.id}`,children:e.jsx(xe,{className:"h-4 w-4 text-destructive"})})]})]}),(t.redirectUrl||t.webhookUrl)&&e.jsxs("div",{className:"space-y-2 border-t pt-3",children:[e.jsxs("div",{className:"flex flex-wrap gap-4 text-xs",children:[t.redirectUrl&&e.jsxs("div",{className:"flex items-center gap-1 text-muted-foreground",children:[e.jsx(me,{className:"h-3 w-3"}),e.jsx("span",{children:"Redirection:"}),e.jsx("span",{className:"font-mono truncate max-w-[200px]",children:t.redirectUrl})]}),t.webhookUrl&&e.jsxs("div",{className:"flex items-center gap-1 text-muted-foreground",children:[e.jsx(Pe,{className:"h-3 w-3"}),e.jsx("span",{children:"Webhook:"}),e.jsx("span",{className:"font-mono truncate max-w-[200px]",children:t.webhookUrl})]})]}),t.webhookSecret&&e.jsxs("div",{className:"flex items-center gap-2 text-xs",children:[e.jsx("span",{className:"text-muted-foreground",children:"Secret:"}),e.jsx("code",{className:"font-mono text-muted-foreground bg-muted px-2 py-0.5 rounded truncate max-w-[200px]",children:t.webhookSecret}),e.jsx(x,{variant:"ghost",size:"sm",className:"h-6 w-6 p-0",onClick:()=>re(t.webhookSecret),"data-testid":`button-copy-secret-${t.id}`,children:te===t.webhookSecret?e.jsx(R,{className:"h-3 w-3"}):e.jsx(B,{className:"h-3 w-3"})})]})]})]});return e.jsxs(I,{children:[e.jsxs("div",{className:"space-y-6 p-6",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-bold",children:"API de Paiement"}),e.jsx("p",{className:"text-muted-foreground",children:"Gérez vos clés d'intégration SendavaPay"})]}),E&&!w&&e.jsxs(f,{children:[e.jsxs(y,{children:[e.jsxs(N,{className:"flex items-center gap-2",children:[e.jsx(Q,{className:"h-5 w-5"}),"Créer une clé API"]}),e.jsx(T,{children:"Choisissez le type d'intégration adapté à votre projet"})]}),e.jsx(b,{children:e.jsxs("div",{className:"grid sm:grid-cols-2 gap-4",children:[e.jsxs("button",{className:"p-5 border-2 rounded-xl text-left hover:border-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900/10 transition-all group",onClick:()=>C("sdk"),children:[e.jsxs("div",{className:"flex items-center gap-3 mb-3",children:[e.jsx("div",{className:"h-10 w-10 rounded-lg bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center group-hover:bg-purple-200 transition-colors",children:e.jsx(_,{className:"h-5 w-5 text-purple-600 dark:text-purple-400"})}),e.jsxs("div",{children:[e.jsx("p",{className:"font-semibold",children:"API SDK"}),e.jsx("p",{className:"text-xs text-muted-foreground",children:"Intégration complète"})]})]}),e.jsx("ul",{className:"text-sm text-muted-foreground space-y-1",children:["Encaissement Mobile Money (10 pays)","Retrait automatique pay-out","Soldes wallets par pays","Webhooks signés HMAC"].map(t=>e.jsxs("li",{className:"flex items-center gap-2",children:[e.jsx(R,{className:"h-3 w-3 text-green-500 flex-shrink-0"}),t]},t))})]}),e.jsxs("button",{className:"p-5 border-2 rounded-xl text-left hover:border-primary hover:bg-primary/5 transition-all group",onClick:()=>C("redirect"),children:[e.jsxs("div",{className:"flex items-center gap-3 mb-3",children:[e.jsx("div",{className:"h-10 w-10 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center group-hover:bg-blue-200 transition-colors",children:e.jsx(me,{className:"h-5 w-5 text-blue-600 dark:text-blue-400"})}),e.jsxs("div",{children:[e.jsx("p",{className:"font-semibold",children:"API Redirection"}),e.jsx("p",{className:"text-xs text-muted-foreground",children:"Simple et rapide"})]})]}),e.jsx("ul",{className:"text-sm text-muted-foreground space-y-1",children:["Liens de paiement générés","Redirection après paiement","Notifications webhook","Intégration sans SDK"].map(t=>e.jsxs("li",{className:"flex items-center gap-2",children:[e.jsx(R,{className:"h-3 w-3 text-green-500 flex-shrink-0"}),t]},t))})]})]})})]}),(E&&w||!E&&ae)&&e.jsxs(f,{children:[e.jsxs(y,{children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx(N,{className:"flex items-center gap-2",children:w==="sdk"?e.jsxs(e.Fragment,{children:[e.jsx(_,{className:"h-5 w-5 text-purple-600"}),"Nouvelle clé API SDK"]}):e.jsxs(e.Fragment,{children:[e.jsx(U,{className:"h-5 w-5 text-primary"}),"Nouvelle clé API"]})}),E?e.jsxs(x,{variant:"ghost",size:"sm",onClick:()=>C(null),"data-testid":"button-back-type",children:[e.jsx(J,{className:"h-4 w-4 mr-1"}),"Changer"]}):e.jsxs(x,{variant:"ghost",size:"sm",onClick:()=>D(!1),"data-testid":"button-cancel-create",children:[e.jsx(J,{className:"h-4 w-4 mr-1"}),"Annuler"]})]}),e.jsx(T,{children:w==="sdk"?"Clé pour l'intégration SDK complète avec retrait automatique":"Clé pour la création de liens de paiement avec redirection"})]}),e.jsxs(b,{className:"space-y-4",children:[e.jsxs("div",{className:"grid sm:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx(z,{htmlFor:"keyName",children:"Nom de la clé *"}),e.jsx(K,{id:"keyName",placeholder:"Ex: Mon site e-commerce",value:c,onChange:t=>g(t.target.value),"data-testid":"input-key-name"})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(z,{htmlFor:"appName",children:"Nom de l'application"}),e.jsx(K,{id:"appName",placeholder:"Ex: MaBoutique.com",value:v,onChange:t=>s(t.target.value),"data-testid":"input-app-name"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(z,{htmlFor:"redirectUrl",children:"URL de redirection (après paiement)"}),e.jsx(K,{id:"redirectUrl",type:"url",placeholder:"https://monsite.com/paiement/succes",value:u,onChange:t=>M(t.target.value),"data-testid":"input-redirect-url"})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(z,{htmlFor:"webhookUrl",children:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(Ae,{className:"h-4 w-4"}),"URL de webhook"]})}),e.jsx(K,{id:"webhookUrl",type:"url",placeholder:"https://monsite.com/webhooks/sendavapay",value:n,onChange:t=>l(t.target.value),"data-testid":"input-webhook-url"}),e.jsx("p",{className:"text-xs text-muted-foreground",children:"SendavaPay enverra une notification POST sécurisée à cette URL lors de chaque paiement"})]}),e.jsxs(x,{onClick:he,disabled:V.isPending,className:w==="sdk"?"bg-purple-600 hover:bg-purple-700":"","data-testid":"button-create-key",children:[V.isPending?e.jsx(A,{className:"h-4 w-4 mr-2 animate-spin"}):e.jsx(U,{className:"h-4 w-4 mr-2"}),"Générer la clé"]})]})]}),!pe&&e.jsx(e.Fragment,{children:E?e.jsxs(be,{defaultValue:k.length>0?"sdk":"redirect",children:[e.jsxs(ye,{children:[e.jsxs(de,{value:"sdk",className:"gap-2",children:[e.jsx(_,{className:"h-4 w-4"}),"Clés SDK",k.length>0&&e.jsx(L,{variant:"secondary",className:"ml-1 h-5 text-xs",children:k.length})]}),e.jsxs(de,{value:"redirect",className:"gap-2",children:[e.jsx(ee,{className:"h-4 w-4"}),"Clés Redirection",h.length>0&&e.jsx(L,{variant:"secondary",className:"ml-1 h-5 text-xs",children:h.length})]})]}),e.jsxs(le,{value:"sdk",className:"space-y-4 mt-4",children:[e.jsxs(f,{children:[e.jsxs(y,{children:[e.jsxs(N,{className:"flex items-center gap-2 text-base",children:[e.jsx(_,{className:"h-4 w-4 text-purple-600"}),"Clés API SDK"]}),e.jsxs(T,{children:[k.length," clé",k.length!==1?"s":""," SDK"]})]}),e.jsx(b,{children:H?e.jsx("div",{className:"flex justify-center py-8",children:e.jsx(A,{className:"h-6 w-6 animate-spin text-muted-foreground"})}):k.length===0?e.jsxs("div",{className:"text-center py-8 text-muted-foreground",children:[e.jsx(_,{className:"h-12 w-12 mx-auto mb-3 opacity-50"}),e.jsx("p",{children:"Aucune clé SDK créée"}),e.jsx("p",{className:"text-sm",children:'Cliquez sur "Créer une clé API" pour commencer'})]}):e.jsx("div",{className:"space-y-3",children:k.map(t=>e.jsx(Y,{keyItem:t},t.id))})})]}),e.jsxs("div",{children:[e.jsxs("h2",{className:"text-xl font-bold mb-4 flex items-center gap-2",children:[e.jsx(q,{className:"h-5 w-5 text-purple-600"}),"Référence API SDK"]}),e.jsx(Ee,{apiKeys:$})]})]}),e.jsxs(le,{value:"redirect",className:"space-y-4 mt-4",children:[e.jsxs(f,{children:[e.jsxs(y,{children:[e.jsxs(N,{className:"flex items-center gap-2 text-base",children:[e.jsx(ee,{className:"h-4 w-4 text-blue-600"}),"Clés API Redirection"]}),e.jsxs(T,{children:[h.length," clé",h.length!==1?"s":""," Redirection"]})]}),e.jsx(b,{children:H?e.jsx("div",{className:"flex justify-center py-8",children:e.jsx(A,{className:"h-6 w-6 animate-spin text-muted-foreground"})}):h.length===0?e.jsxs("div",{className:"text-center py-8 text-muted-foreground",children:[e.jsx(ee,{className:"h-12 w-12 mx-auto mb-3 opacity-50"}),e.jsx("p",{children:"Aucune clé créée"})]}):e.jsx("div",{className:"space-y-3",children:h.map(t=>e.jsx(Y,{keyItem:t},t.id))})})]}),e.jsxs(f,{children:[e.jsx(y,{children:e.jsxs(N,{className:"flex items-center gap-2 text-base",children:[e.jsx(q,{className:"h-4 w-4"}),"Documentation"]})}),e.jsx(b,{children:e.jsx(F,{href:"/docs",children:e.jsxs(x,{variant:"outline","data-testid":"button-docs-redirect",children:[e.jsx(q,{className:"h-4 w-4 mr-2"}),"Voir la documentation"]})})})]})]})]}):e.jsxs("div",{className:"space-y-4",children:[e.jsxs(f,{children:[e.jsx(y,{children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsxs(N,{className:"flex items-center gap-2 text-base",children:[e.jsx(U,{className:"h-4 w-4 text-primary"}),"Mes clés API"]}),e.jsxs(T,{children:[h.length," clé",h.length!==1?"s":""]})]}),!ae&&e.jsxs(x,{size:"sm",onClick:()=>{D(!0),C("redirect")},"data-testid":"button-new-key",children:[e.jsx(Q,{className:"h-4 w-4 mr-2"}),"Nouvelle clé"]})]})}),e.jsx(b,{children:H?e.jsx("div",{className:"flex justify-center py-8",children:e.jsx(A,{className:"h-6 w-6 animate-spin text-muted-foreground"})}):h.length===0?e.jsxs("div",{className:"text-center py-8 text-muted-foreground",children:[e.jsx(U,{className:"h-12 w-12 mx-auto mb-3 opacity-50"}),e.jsx("p",{children:"Aucune clé créée"}),e.jsxs(x,{className:"mt-3",size:"sm",onClick:()=>{D(!0),C("redirect")},"data-testid":"button-create-first-key",children:[e.jsx(Q,{className:"h-4 w-4 mr-2"}),"Créer ma première clé"]})]}):e.jsx("div",{className:"space-y-3",children:h.map(t=>e.jsx(Y,{keyItem:t},t.id))})})]}),e.jsx(f,{children:e.jsx(b,{className:"pt-6",children:e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:"h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0",children:e.jsx(q,{className:"h-5 w-5 text-primary"})}),e.jsxs("div",{className:"flex-1",children:[e.jsx("p",{className:"font-medium",children:"Documentation API"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Consultez la documentation pour intégrer SendavaPay dans votre application"})]}),e.jsx(F,{href:"/docs",children:e.jsxs(x,{variant:"outline","data-testid":"button-docs",children:[e.jsx(q,{className:"h-4 w-4 mr-2"}),"Voir la documentation"]})})]})})})]})})]}),e.jsx(Ne,{open:!!S,onOpenChange:t=>!t&&G(null),children:e.jsxs(ve,{children:[e.jsxs(we,{children:[e.jsx(ke,{children:"Supprimer cette clé API ?"}),e.jsxs(Te,{children:['Êtes-vous sûr de vouloir supprimer la clé "',S==null?void 0:S.name,'" ? Cette action est irréversible et toutes les intégrations utilisant cette clé cesseront de fonctionner.']})]}),e.jsxs(Ce,{children:[e.jsx(Se,{children:"Annuler"}),e.jsxs(Oe,{onClick:()=>{S&&(W.mutate(S.id),G(null))},className:"bg-destructive text-destructive-foreground hover:bg-destructive/90",children:[W.isPending?e.jsx(A,{className:"h-4 w-4 mr-2 animate-spin"}):e.jsx(xe,{className:"h-4 w-4 mr-2"}),"Supprimer"]})]})]})})]})}export{vt as default};
