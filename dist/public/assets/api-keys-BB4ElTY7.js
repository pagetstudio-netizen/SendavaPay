...
}`})]}),e.jsxs("div",{id:"s-list",className:"scroll-mt-4 mb-14",children:[e.jsx("h3",{className:"text-lg font-semibold mb-1",children:"Lister les transactions"}),e.jsx("p",{className:"text-sm text-muted-foreground mb-3",children:"Retourne toutes les transactions (pay-in + pay-out) de votre compte."}),e.jsx(l,{method:"GET",path:"/api/sdk/v1/transactions"}),e.jsx(a,{language:"curl",code:`curl https://sendavapay.com/api/sdk/v1/transactions \\
  -H "Authorization: Bearer ${r}"`}),e.jsxs("h4",{className:"text-xs font-semibold uppercase tracking-wide text-muted-foreground mt-5 mb-2",children:["Réponse ",e.jsx("span",{className:"text-green-600 dark:text-green-400",children:"200 OK"})]}),e.jsx(a,{language:"json",code:`{
  "success": true,
  "data": {
    "transactions": [
...
console.log(\`\${data.summary.online} opérateurs disponibles\`);`}]}),e.jsxs("h4",{className:"text-xs font-semibold uppercase tracking-wide text-muted-foreground mt-5 mb-2",children:["Réponse ",e.jsx("span",{className:"text-green-600 dark:text-green-400",children:"200 OK"})]}),e.jsx(a,{language:"json",code:`{
  "success": true,
  "data": {
    "summary": {
      "online":  12,
...
}`})]}),e.jsxs("div",{id:"s-countries",className:"scroll-mt-4 mb-14",children:[e.jsx("h3",{className:"text-lg font-semibold mb-1",children:"Pays disponibles"}),e.jsx("p",{className:"text-sm text-muted-foreground mb-3",children:"Retourne la liste des pays activés avec leur devise."}),e.jsx(l,{method:"GET",path:"/api/sdk/v1/countries"}),e.jsx(a,{language:"javascript",code:`const res = await fetch('https://sendavapay.com/api/sdk/v1/countries');
const { data } = await res.json();
